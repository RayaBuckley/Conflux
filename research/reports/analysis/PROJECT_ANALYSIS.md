...
| 2 August fourth-year direction | Proposed planning, delegation, argument policy, disclosure, attribution, verification reduction, benchmark, PDP, and governance work | Reconciled by specification 018; COI reduction is first, delegation stays disabled until its gates pass |
...
| 24 August evidence visualisation and workflow | Proposed human-reviewable evidence visualisation (deterministic SVG/HTML projections of existing machine-checkable evidence) and AI-assisted development workflow improvement (staged discover–falsify–research–specify–implement–verify–audit cycle) | Archived in reports/archive/2026-08-24-evidence-visualisation-and-workflow/; pending ADR-021 and ADR-022 acceptance; WORKFLOW.md references are interpreted as pointing to AGENTS.md and docs/AI_AGENT_GUIDE.md |
