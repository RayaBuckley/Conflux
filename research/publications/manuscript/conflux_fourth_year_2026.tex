...
$PC(\text{scheduling context})$. Only an explicitly trusted, separately
modelled transformation may reduce influence.
...
organisation's existing access-control system. Classical IFC systems
...
duties, framing the future trusted-transformation question.
...
within authorised actions. Conservative
