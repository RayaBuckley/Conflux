"""Generate or byte-check the curated offline Cedar preflight bundle."""
...
from conflux.experiments import compare_cedar_preflight_bundle, generate_cedar_preflight_bundle
...
def main() -> int:
    ...
    if not protocol_path.is_file():
        print(f"Cedar preflight evidence is missing: {protocol_path}", file=sys.stderr)
        return 1
    ...
    if changed:
        ...
        return 1
    print("Cedar preflight evidence regeneration check passed")
    return 0
